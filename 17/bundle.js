...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "isEqualCities": () => (/* binding */ isEqualCities),
/* harmony export */   "servises": () => (/* binding */ servises),
...
const isEqualCities = (inputValue) =>{
...
/* harmony export */ });
/* harmony import */ var _abstract_observable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstract-observable */ "./src/abstract-observable.js");
...
class FilterModel extends _abstract_observable__WEBPACK_IMPORTED_MODULE_0__["default"]{
    #filter = _utils_const__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING;
...
class PointModel extends _abstract_observable__WEBPACK_IMPORTED_MODULE_0__["default"]{
    #points = [];
...
/* harmony import */ var _view_new_point_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/new-point-view */ "./src/view/new-point-view.js");
...
class NewPointPresenter {
  ...
  init = (point) => {
    ...
    this.#pointComponent = new _view_point_view__WEBPACK_IMPORTED_MODULE_0__["default"](point);
    this.#pointEditComponent = new _view_new_point_view__WEBPACK_IMPORTED_MODULE_1__["default"](point);
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this.#pointContainer, this.#pointEditComponent, _render_js__WEBPACK_IMPORTED_MODULE_2__.renderPosition.AFTERBEGIN);
  ...
  destroy = () => {
    ;(0,_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.#pointComponent);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this.#pointEditComponent);
  }

  #replacePointToForm = () => {
    ;(0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this.#pointEditComponent, this.#pointComponent);
    this.#mode = Mode.EDITING;
  }

  #replaceFormToPoint = () => {
    this.#pointComponent = null;
    (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this.#pointComponent, this.#pointEditComponent);
  ...
  #handleFavorite = () => {
    this.#changeAction(_utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateAction.UPDATE_POINT, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.PATCH, { ...this.#point, isFavorite: !this.#point.isFavorite });
  }
  ...
  #handleFormSubmit = (point) => {
    ...
    const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](this.#pointContainer, this.#changeAction);
    this.#pointPresenters.set(point.id, pointPresenter);
    this.#changeAction(_utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateAction.ADD_POINT, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MAJOR, point);
...
class PointPresenter {
  ...
  init = (point) => {
    ...
    this.#pointComponent = new _view_point_view__WEBPACK_IMPORTED_MODULE_0__["default"](point);
    this.#pointEditComponent = new _view_offer_form_view__WEBPACK_IMPORTED_MODULE_1__["default"](point);

    this.#pointComponent.setEditClickHandler(this.#handleEdit);
    this.#pointEditComponent.setFormSubmitHandler(this.#handleFormSubmit);
    this.#pointEditComponent.setFormDeleteHandler(this.#handleFormReset);
    this.#pointComponent.setFavoriteClickHandler(this.#handleFavorite);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this.#pointContainer, this.#pointComponent, _render_js__WEBPACK_IMPORTED_MODULE_2__.renderPosition.BEFOREEND);

    if (this.#mode === Mode.DEFAULT && prevPointComponent) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this.#pointComponent, prevPointComponent);
    }
    if (this.#mode === Mode.EDITING && prevEditPointComponent) {
      (0,_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this.#pointEditComponent, prevEditPointComponent);
    }
  ...
  #handleFormSubmit = (point) => {
    ...
    this.#changeAction(_utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateAction.UPDATE_POINT, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.PATCH, point);
  }
  ...
  #handleFormReset = (point) => {
    this.#replaceFormToPoint();
    this.#changeAction(_utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateAction.DELETE_POINT, _utils_const__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, point);
  }
}
...
/* harmony import */ var _view_header_info_view__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../view/header-info-view */ "./src/view/header-info-view.js");
/* harmony import */ var _view_filter_view__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/filter-view */ "./src/view/filter-view.js");
/* harmony import */ var _new_point_presenter__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./new-point-presenter */ "./src/presenter/new-point-presenter.js");
...
class TripPresenter {
  ...
  #currentFilter = _utils_const__WEBPACK_IMPORTED_MODULE_10__.FilterType.EVERYTHING;
  #noPointsComponent = new _view_empty_points_list__WEBPACK_IMPORTED_MODULE_2__["default"](this.#currentFilter);
  #sortComponent = null;
  #pointListComponent = new _view_point_list_view__WEBPACK_IMPORTED_MODULE_1__["default"]();
  #pointModel = null;
  #filterModel = null;
  ...
  constructor(tripContainer, pointsModel, headerMenu, filterModel, filterContainer) {
    ...
    this.#newPointPresenter = new _new_point_presenter__WEBPACK_IMPORTED_MODULE_8__["default"](this.#pointListComponent,  this.#handleViewAction, this.#pointPresenter);

  }


  init = () => {
    (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(this.#tripContainer, this.#pointListComponent, _render_js__WEBPACK_IMPORTED_MODULE_3__.renderPosition.BEFOREEND);
  ...
  get points(){
    ...
    const filteredPoints = _utils_filter__WEBPACK_IMPORTED_MODULE_5__.filters[filterType](this.#pointModel.points);
    switch(this.#currentSortType){
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.SortType.PRICE.text:
        return filteredPoints.sort(_utils_const__WEBPACK_IMPORTED_MODULE_10__.sortPointsByPrice);
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.SortType.TIME.text:
        return filteredPoints.sort(_utils_const__WEBPACK_IMPORTED_MODULE_10__.sortPointsByTime);
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.SortType.DAY.text:
        return filteredPoints.sort(_utils_const__WEBPACK_IMPORTED_MODULE_10__.sortPointsByDate);
    }
  ...
  #handleViewAction = (actionType, updateType, update) =>{
    switch(actionType){
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateAction.UPDATE_POINT:
        this.#pointModel.updatePoint(updateType, update);
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateAction.ADD_POINT:
        this.#pointModel.addPoint(updateType, update);
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateAction.DELETE_POINT:
  ...
  #handleModeEvent = (updateType, data = null) => {
    switch(updateType){
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateType.PATCH:
        this.#pointPresenter.get(data.id).init(data);
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateType.MINOR:
        this.#clearBoard();
        this.#renderBoard();
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateType.MAJOR:
  ...
  #renderHeaderInfo = () => {
    if (this.points.length !== 0) {
      this.#headerInfoComponent = new _view_header_info_view__WEBPACK_IMPORTED_MODULE_6__["default"](this.points[0]).element;
      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(this.#headerMenuContainer, this.#headerInfoComponent, _render_js__WEBPACK_IMPORTED_MODULE_3__.renderPosition.AFTERBEGIN);
    }
  }

  #renderPoint = (point) => {
    const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](this.#pointListComponent, this.#handleViewAction);
  ...
  #handleSortTypeChange = (sortType) => {
    ...
    this.#handleModeEvent(_utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateType.MINOR);
  }

  #renderNoPoints = () => {
    this.#noPointsComponent = new _view_empty_points_list__WEBPACK_IMPORTED_MODULE_2__["default"](this.#currentFilter);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(this.#tripContainer, this.#noPointsComponent, _render_js__WEBPACK_IMPORTED_MODULE_3__.renderPosition.BEFOREEND);
  }
  ...
  #renderBoard = (isFirstRendering = false, isMajor = false) => {
    ...
    if(this.#currentSortType === null){
      this.#currentSortType = _utils_const__WEBPACK_IMPORTED_MODULE_10__.SortType.DAY;
    }
    if(this.#currentFilter === null){
      this.#currentFilter = _utils_const__WEBPACK_IMPORTED_MODULE_10__.FilterType.EVERYTHING;
    }
    if(isFirstRendering){
  ...
  #clearBoard = ({resetSortType = false} = {}, isMajor = false) => {
    ...
    if(isMajor){
      (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(this.#filterComponent);
      this.#filterComponent = null;
    }

    this.#headerInfoComponent = null;
    (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(this.#noPointsComponent);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.remove)(this.#sortComponent);
  }

  #renderFilter = () =>{
    this.#filterComponent = new _view_filter_view__WEBPACK_IMPORTED_MODULE_7__["default"](this.#currentFilter, this.#newPointPresenter);
    this.#filterComponent.setFilterTypeChangeHandler(this.#handleFilterChange);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(this.#filterContainer, this.#filterComponent, _render_js__WEBPACK_IMPORTED_MODULE_3__.renderPosition.BEFOREEND);
  }

  #renderSort = () => {
    this.#sortComponent = new _view_sort_view__WEBPACK_IMPORTED_MODULE_0__["default"](this.#currentSortType);
    this.#sortComponent.setSortChangeClickHandler(this.#handleSortTypeChange);
    (0,_render_js__WEBPACK_IMPORTED_MODULE_3__.render)(this.#tripContainer, this.#sortComponent, _render_js__WEBPACK_IMPORTED_MODULE_3__.renderPosition.AFTERBEGIN);
  }
  ...
  createPoint = () => {
    ...
    this.#handleModeEvent(_utils_const__WEBPACK_IMPORTED_MODULE_10__.UpdateType.MAJOR);

    const point = (0,_mock_point__WEBPACK_IMPORTED_MODULE_9__.generatePoint)();
...
const sortPointsByDate = (pointA, pointB) => pointB.month - pointA.month;
...
const filters = {
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.EVERYTHING]: (points) => points.filter(() => true),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.FUTURE]: (points) => points.filter((point)=> isPointFuture(point)),
  [_const__WEBPACK_IMPORTED_MODULE_0__.FilterType.PAST]: (points) => points.filter((point)=> isPointPast(point))
};
...
const NoPointTextType = {
  [_utils_const_js__WEBPACK_IMPORTED_MODULE_2__.FilterType.EVERYTHING]: 'Click New Event to create your first point',
  [_utils_const_js__WEBPACK_IMPORTED_MODULE_2__.FilterType.FUTURE]: 'There are no future events now',
  [_utils_const_js__WEBPACK_IMPORTED_MODULE_2__.FilterType.PAST]: 'There are no past events now',
};
...
class MessageWithoutPoints extends _abstract_view_js__WEBPACK_IMPORTED_MODULE_0__["default"]{
  ...
  get element(){
    if(this.#element === null){
      this.#element =  (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(this.template);
    }
...
const createFilterTemplate = ( currentFilterType, isFilterDisabled) => (
  `<form class="trip-filters" action="#" method="get">
    <div class="trip-filters__filter">
      <input id="filter-everything" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING}" ${currentFilterType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING ? 'checked' : ''}>
      <label class="trip-filters__filter-label" for="filter-everything">Everything</label>
    </div>

    <div class="trip-filters__filter">
      <input id="filter-future" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE}"  ${currentFilterType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE ? 'checked' : ''} ${isFilterDisabled ? 'disabled' : ''}>
      <label class="trip-filters__filter-label" for="filter-future">Future</label>
    </div>

    <div class="trip-filters__filter">
      <input id="filter-past" class="trip-filters__filter-input  visually-hidden" type="radio" name="trip-filter" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST}" ${currentFilterType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST ? 'checked' : ''} ${isFilterDisabled ? 'disabled' : ''}>
...
const createOfferForm = (point) => {
  ...
  const startEventTime = dayjs__WEBPACK_IMPORTED_MODULE_4___default()(dateStartEvent).format('DD/MM/YY H:m');
  const endEventTime = dayjs__WEBPACK_IMPORTED_MODULE_4___default()(dateEndEvent).format('DD/MM/YY H:m');
  const offersForm = _mock_point__WEBPACK_IMPORTED_MODULE_1__.servises[point.pointType];
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--destination">
            ...
            <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_5___default().encode(destination)}" list="destination-list-1">
...
class NewPointView extends _smart_view__WEBPACK_IMPORTED_MODULE_0__["default"] {
  #datepicker = null;
  ...
  #setDatePickerStart =()=>{
    this.#datepicker = (0,flatpickr__WEBPACK_IMPORTED_MODULE_2__["default"])(
...
class SmartView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"]{
    ...
    #updateDestinationHandler = (evt) =>{
      evt.preventDefault();
      if((0,_mock_point__WEBPACK_IMPORTED_MODULE_1__.isEqualCities)(evt.target.value)){
        this.updateData({destination : evt.target.value, destinationInfo : {description: (0,_mock_point__WEBPACK_IMPORTED_MODULE_1__.generateDescription)(),
          pictures : (0,_mock_point__WEBPACK_IMPORTED_MODULE_1__.generatePictures)()}});
      }
    }
    ...
    renderOffers = (pointDestination) =>{
      const count = _mock_point__WEBPACK_IMPORTED_MODULE_1__.servises[pointDestination].length;
...
const CreateSortTemplate = (sortType = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY) =>
  (`<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
            <div class="trip-sort__item  trip-sort__item--day">
              <input id="sort-day" class="trip-sort__input  visually-hidden ${sortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY.text ? 'board__sort-item--active' : ''}" type="radio" name="trip-sort" data-sort-type="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY.text}" value="sort-day">
            ...
            <div class="trip-sort__item  trip-sort__item--time">
              <input id="sort-time" class="trip-sort__input  visually-hidden ${sortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY.text ? 'board__sort-item--active' : ''}" type="radio" name="trip-sort" value="sort-time" data-sort-type="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.TIME.text}" >
              <label class="trip-sort__btn" for="sort-time">Time</label>
            </div>

            <div class="trip-sort__item  trip-sort__item--price">
              <input id="sort-price" class="trip-sort__input  visually-hidden ${sortType === _utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.DAY.text ? 'board__sort-item--active' : ''}" type="radio" name="trip-sort" value="sort-price" data-sort-type="${_utils_const_js__WEBPACK_IMPORTED_MODULE_1__.SortType.PRICE.text}" >
...
/* harmony import */ var _model_point_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/point-model */ "./src/model/point-model.js");
...
const POINT_COUNT = 4;
const points = Array.from({ length: POINT_COUNT }, _mock_point__WEBPACK_IMPORTED_MODULE_2__.generatePoint);
...
const pointModel = new _model_point_model__WEBPACK_IMPORTED_MODULE_4__["default"]();
const filterModel = new _model_filter_model__WEBPACK_IMPORTED_MODULE_5__["default"]();

pointModel.points = points;

const tripPresenter = new _presenter_trip_presenter__WEBPACK_IMPORTED_MODULE_3__["default"](mainContainer, pointModel, headerMenu, filterModel, filtersElement);

(0,_render__WEBPACK_IMPORTED_MODULE_1__.render)(siteMenuElement, new _view_site_menu_view__WEBPACK_IMPORTED_MODULE_0__["default"](), _render__WEBPACK_IMPORTED_MODULE_1__.renderPosition.BEFOREEND);
