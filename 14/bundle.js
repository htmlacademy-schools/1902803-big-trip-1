...
class TripPresenter {
  ...
  #noPointsComponent = new _view_empty_points_list__WEBPACK_IMPORTED_MODULE_2__["default"]();
  #sortComponent = new _view_sort_view__WEBPACK_IMPORTED_MODULE_0__["default"]();
  ...
  #handlePointChange = (updatePoint) => {
    this.#boardPoints = (0,_common__WEBPACK_IMPORTED_MODULE_5__.updateItem)(this.#boardPoints, updatePoint);
  ...
  #sortPoints = (sortType) => {
    switch (sortType) {
      case _utils_sort_functions__WEBPACK_IMPORTED_MODULE_6__.SortType.PRICE.text:
        this.#boardPoints.sort(_utils_sort_functions__WEBPACK_IMPORTED_MODULE_6__.sortPointsByPrice);
        break;
      case _utils_sort_functions__WEBPACK_IMPORTED_MODULE_6__.SortType.TIME.text:
        this.#boardPoints.sort(_utils_sort_functions__WEBPACK_IMPORTED_MODULE_6__.sortPointsByTime);
        break;
      default:
  ...
  #renderPoint = (point) => {
    const pointPresenter = new _point_presenter__WEBPACK_IMPORTED_MODULE_4__["default"](this.#pointListComponent, this.#handlePointChange, this.#handleModeChange);
...
class SmartView extends _abstract_view__WEBPACK_IMPORTED_MODULE_0__["default"]{
    ...
    renderOffers = (point) =>{
      const count = _mock_point__WEBPACK_IMPORTED_MODULE_1__.servises[point].length;
...
const POINT_COUNT = 4;
const points = Array.from({ length: POINT_COUNT }, _mock_point__WEBPACK_IMPORTED_MODULE_4__.generatePoint);
